...
function sendEmailWithAttachment(data, attachmentName, attachmentData, attachmentMimeType) {
    var stringifiedData = JSON.stringify(data);
    if (debug) print("sendEmailWithAttachment(data=" + stringifiedData);
    FF_JS_API.sendEmailWithAttachment(JSON.parse(stringifiedData), attachmentName, attachmentData, attachmentMimeType);
}
